...
// YouTube API
$result = get_CURL('https://www.googleapis.com/youtube/v3/channels?part=snippet,statistics&id=UCP70plucjQ0YRS48r68QM8Q&key=AIzaSyAzSI2ytW3EYow1elVtMpXraRstHM5r0Wc');
...
//latest video
$urlLatestVideo = 'https://www.googleapis.com/youtube/v3/search?key=AIzaSyAzSI2ytW3EYow1elVtMpXraRstHM5r0Wc&channelId=UCP70plucjQ0YRS48r68QM8Q&maxResults=1&order=date&part=snippet';
$result = get_CURL($urlLatestVideo);
$latestVideoId = $result ['items'] ['0'] ['id'] ['videoId'];

// Instagram API
$instagramAccessToken = "IGAAPlegmZBEo1BZAE45WXBXZAS0yNENzaWR6bjR2QTMwa3ZALRTF3RWdSbWhyVm1qcS1Kc3ZAxMS0wRDhRU3dGWU15WE5jMDQwQmxvQm83bFJ6ekxlVl8tY0FZANkE4anh0VnY5VkpTTkhZAdWxoSHJpUDhSR01DdlNONnlHWjRBSXpENAZDZD";
...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
        <a class="navbar-brand" href="#home">Asraf Wisma Putra</a>
    ...
    <section class="about" id="about">
      <div class="container">
        ...
        <div class="row justify-content-center">
          <div class="col-md-5">
            <p>Halo! Saya Asraf Wisma Putra, Bisa dipanggil Asraf, Saya berusia 21 tahun, saya merupakan anak kedua dari 3 bersaudara. Asal saya dari dharmasraya</p>
          </div>
          <div class="col-md-5">
            <p>Saya adalah mahasiswa program studi sistem informasi di Universitas Islam Negeri Imam Bonjo Padang. pada saat ini saya berada di Semester 6. Saya sangat tertarik untuk menjadi desainer UI/UX</p>
          </div>
        </div>
      </div>
    </section>
          ...
          <div class="col-md-5">
            <div class="row">
              ...
              <div class="col-md-8">
                ...
                <div class="g-ytsubscribe" data-channelid="UCP70plucjQ0YRS48r68QM8Q" data-layout="full" data-count="default"></div>
              </div>
            </div>
          ...
          <div class="col-lg-4">
            <div class="card bg-primary text-white mb-4 text-center">
              <div class="card-body">
                ...
                <p class="card-text">081374428407 @Asrafsaputra792@gmail.com</p>
              </div>
            </div>
            ...
            <ul class="list-group mb-4">
              ...
              <li class="list-group-item">7R2M+2C5 Desa gunung medan, Kabupaten Dharmasraya, Sumatera Barat</li>
